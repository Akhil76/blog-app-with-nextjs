        ...
        <div class="max-w-md w-full mt-28">
          ...
          <div class="p-8 rounded-2xl bg-white shadow">
            ...
            <form class="mt-4 space-y-4">
              ...
              <p class="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <Link href="/signup" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</Link></p>
            </form>
          </div>
        </div>
      </div>
